...
public interface AppPurchasingObserverListener {
   ...
   * to sku passed into initiatePurchaseRequest.
	 ...
	 * for each receipt.  For subscriptions, extra parameter passed to indicate whether
	 ...
	 */
	public void onPurchaseUpdatesResponseSuccess(String userId, String sku, String purchaseToken, boolean isSubscriptionActive);
