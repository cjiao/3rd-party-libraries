        ...
        if ([self cameraPosition] == AVCaptureDevicePositionBack)
        {
            if (_horizontallyMirrorRearFacingCamera)
            {
                switch(_outputImageOrientation)
                {
                    ...
                    case UIInterfaceOrientationUnknown:outputRotation = kGPUImageRotateRightFlipVertical; break;
                }
            }
            else
            {
                switch(_outputImageOrientation)
                {
                    ...
                    case UIInterfaceOrientationUnknown:outputRotation = kGPUImageRotateRight; break;
                }
            }
        }
        else
